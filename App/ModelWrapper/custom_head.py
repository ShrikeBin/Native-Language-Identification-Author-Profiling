...
class MixedClassifier(nn.Module):
    def __init__(self, num_classes = 20):
        ...
        self.robert = RobertaForSequenceClassification.from_pretrained("Training/MODELS/language/classificationRoBERT/model")
        self.cnn = RobertCNN(self.robert, num_classes=num_classes)
        
        from safetensors.torch import load_file
        self.cnn.load_state_dict(load_file("Training/MODELS/language/mixedCNNRoBERT/CNN/model.safetensors"))
